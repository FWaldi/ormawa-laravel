...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    ...
    <form action="{{ route('organizations.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
        @csrf
        ...
        <div class="mb-6">
            ...
            <select id="type" 
                ...
                <option value="Student Organization" {{ old('type') == 'Student Organization' ? 'selected' : '' }}>Student Organization</option>
                <option value="Academic Club" {{ old('type') == 'Academic Club' ? 'selected' : '' }}>Academic Club</option>
                <option value="Sports Club" {{ old('type') == 'Sports Club' ? 'selected' : '' }}>Sports Club</option>
                <option value="Arts & Culture" {{ old('type') == 'Arts & Culture' ? 'selected' : '' }}>Arts & Culture</option>
                <option value="Community Service" {{ old('type') == 'Community Service' ? 'selected' : '' }}>Community Service</option>
                <option value="Professional Association" {{ old('type') == 'Professional Association' ? 'selected' : '' }}>Professional Association</option>
            </select>
        </div>
